...
### Fixed
- **Bed/Nozzle iframe overlap on X1 template** (`OBS_settings/templates/default-x1.json`) — math-error caught: bed-temp source is 140 (not 130), so at scale 0.6 it renders 84px tall, pushing Bed's bottom past where Nozzle started. Shifted the rail down 6px and shrunk AMS source to compensate; 3px gaps preserved end-to-end.
